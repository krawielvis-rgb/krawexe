    ...
    <div className="app-shell flex min-h-screen flex-col overflow-x-hidden">
      ...
      <header className="site-header sticky top-0 z-30">
        <div className="mx-auto flex max-w-7xl items-center gap-4 px-5 py-3.5">
          <Link to="/" className="brand group flex items-center gap-3"><span className="brand-mark"><ShieldCheck className="size-5" /></span><span><span className="block font-display text-lg font-bold tracking-wide">KRAWEXE</span><span className="hidden text-[9px] uppercase tracking-[0.25em] text-muted-foreground sm:block">ATS intelligence platform</span></span></Link>
